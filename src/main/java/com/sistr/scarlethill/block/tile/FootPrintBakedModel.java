...
public class FootPrintBakedModel implements IDynamicBakedModel {

    public static final ResourceLocation TEXTURE = new ResourceLocation(ScarletHillMod.MODID, "block/footprint");
    ...
    public List<BakedQuad> getQuads(@Nullable BlockState state, @Nullable Direction side, @Nonnull Random rand, @Nonnull IModelData extraData) {
        ...
        BlockState mimic = extraData.getData(FootPrintTile.MIMIC);
        if (mimic != null && !(mimic.getBlock() instanceof FootPrintBlock)) {
