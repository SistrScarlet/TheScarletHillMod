...
//ポータルパーティクルの色変えバージョン
public class ScarletPortalParticle extends SpriteTexturedParticle {
    private final double portalPosX;
    private final double portalPosY;
    private final double portalPosZ;

    private ScarletPortalParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
        ...
        float rand = this.rand.nextFloat() * 0.6F + 0.4F;
        this.particleRed = rand;
        this.particleGreen = rand * 0.1F;
        this.particleBlue = rand * 0.2F;
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ScarletPortalParticle portalParticle = new ScarletPortalParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
